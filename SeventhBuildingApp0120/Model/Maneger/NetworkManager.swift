...
class NetworkManager {
    ...
    static var floorURL: URL = URL(string: "http://20cm0123.main.jp/building7/floor.php")!
    static var passwordURL: URL = URL(string: "http://20cm0123.main.jp/building7/password.php")!
...
//    }
    ...
    func loadFloors(completion: @escaping (Result<[Floor], Error>) -> Void) {
        loadArray(NetworkManager.floorURL, type: Floor.self) { result in
            DispatchQueue.main.async { completion(result) }
        }
    }
